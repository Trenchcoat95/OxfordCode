...
void KalmanFit(  
                                ...
                                )
    {
      ...
      const int nplanes = 7;
      double Planes_Z[]={1179,1183,1199,1203,1219,1223,1239,1243,1339,1343,1539,1543,1769,1773};
      if (dir<0) 
      {
        Planes_Z[0]=1769;  Planes_Z[1]=1773;
        Planes_Z[2]=1539;  Planes_Z[3]=1543;
        Planes_Z[4]=1339;  Planes_Z[5]=1343;
        Planes_Z[6]=1239;  Planes_Z[7]=1243;
        Planes_Z[8]=1219;  Planes_Z[9]=1223;
        Planes_Z[10]=1199; Planes_Z[11]=1203;
        Planes_Z[12]=1179; Planes_Z[13]=1183;
      }
...
void kalman_helix_garlite_7planesshort(size_t nevents)

    {
      ...
      TFile fs("./toygarlite/7planesshort/nosmear_realseed_elosscorr_fixedp0.7/garlitetest_nosmear_realseed_elosscorr_r001_001_fixedp0.7.root","recreate");
      ...
      ////Kalman
      double Ry = TMath::Sq(0.01);//TMath::Sq(2);//TMath::Sq(0.01);//TMath::Sq(3);
      double Rx = TMath::Sq(0.01);//TMath::Sq(0.01);//TMath::Sq(0.01); //1.1921e-07
      ...
      const int  nplanes = 7 ;
      double  Planes_X[] =   {-300,300,-300,300,-300,300,-300,300,-300,300,-300,300,-300,300};
      double  Planes_Y[] =   {-283.5,-16.5,-322.5,22.5,-350,50,-375,75,-400,100,-400,100,-322.5,22.5};
      double  Planes_Z[] =   {1179,1183,1199,1203,1219,1223,1239,1243,1339,1343,1539,1543,1769,1773};
