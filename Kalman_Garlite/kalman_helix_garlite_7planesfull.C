...
void KalmanFit(  
                                ...
                                )
    {
      ...
      const int nplanes = 7;
      double Planes_Z[]={1179,1183,1199,1203,1219,1223,1239,1243,1339,1343,1539,1543,1704,1708};
      if (dir<0) 
      {
        Planes_Z[0]=1704;  Planes_Z[1]=1708;
...
void kalman_helix_garlite_7planesfull(size_t nevents)

    {
      ...
      TFile fs("./toygarlite/7planesfull/nosmear_realseed_elosscorr_fixedp0.7/garlitetest_nosmear_realseed_elosscorr_r001_001_fixedp0.7.root","recreate");
      ...
      double  Planes_Y[] =   {-283.5,-16.5,-322.5,22.5,-350,50,-375,75,-400,100,-400,100,-400,100};
      double  Planes_Z[] =   {1179,1183,1199,1203,1219,1223,1239,1243,1339,1343,1539,1543,1704,1708};
