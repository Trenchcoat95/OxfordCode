...
namespace gar {
    ...
    private:
        ...
        //std::vector<Double_t>           fTrackTime;         // My thingy
...
void gar::anatree::beginJob() {
    ...
    if (fWriteTracks) {
        ...
        //fTree->Branch("TrackTime",          &fTrackTime); //my thingy
...
void gar::anatree::FillHighLevelRecoInfo(art::Event const & e) {
    ...
    if (fWriteTracks) {
        ...
        for ( auto const& track : (*TrackHandle) ) {
            ...
            //fTrackTime.push_back(track.Time());  //my thingy
            ...
            std::cout<<"ChisqF: "<<track.ChisqForward()<<std::endl;
