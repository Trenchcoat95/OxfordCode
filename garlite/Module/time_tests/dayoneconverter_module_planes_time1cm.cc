...
namespace gar {
    namespace rec {
        ...
        // More initializers here.
        {
            ...
            fZCut2    = p.get<float>("ZCut2",1); // in cm
        ...
        if (true)
        {
                ...
                for (size_t it : unusedTPCplanes.at(i))
                {
                    ...
                    {   
                        ...
                        for (size_t kt : unusedTPCplanes.at(k))
                        {
                            ...
                            //std::cout<<"fZCutCustom: "<<fZCutCustom<<std::endl;
                            ...
                            for (size_t kt2 : unusedTPC)
                            {
                                ...
                                if ((TMath::Abs(zcur - k2pos[2]) > fZCutCustom) &&
                                (tpcclusindexb > -1) &&
                                (dbest < fRCut) )
                                {
            ...
            outfile.open("time1cm.txt", std::ios_base::app); // append instead of overwrite
