    ...
    namespace rec {
        ...
        if (true)
        {
            ...
            while (done==0)
            {
                ...
                {
                for(it = unusedTPCplanes.at(i).begin(); it != unusedTPCplanes.at(i).end(); ++it)
                {
                    ...
                    for(jt = unusedTPCplanes.at(j).begin(); jt != unusedTPCplanes.at(j).end(); ++jt)
                    {
                        //std::cout<<"jt: "<<*jt<<std::endl;
                        ...
                        for(kt = unusedTPCplanes.at(k).begin(); kt != unusedTPCplanes.at(k).end(); ++kt)
                        {
                            //std::cout<<"kt: "<<*kt<<std::endl;
