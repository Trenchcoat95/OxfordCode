...
void FitSlicesYCustom(TH2F * HSTD, TF1* Func, TObjArray &HPROB, std::string type, bool nocut)
{
    ...
    for (Int_t x=1; x<=HSTD->GetNbinsX(); x++)
    {
        ...
        if (projY->GetEntries()>1000)
        {
            ...
            std::string xstring;
            if(nocut)  xstring ="Spill/Slices/"+type+"_SlicesFit_"+std::to_string(x)+"_spill.png";
            else  xstring ="Spill_Fiducial/Slices/"+type+"_SlicesFit_"+std::to_string(x)+".png";
...
{
    float LArFiducial[6] = {-300, +300, -167, 33, 465, 765 }; //all in cm
    ...
    for (Int_t i=0; i<nentries; i++) 
    {
        ...
        for (Int_t j=0; j<PDG->size(); j++) 
        {
           if((PDG->at(j)==13 || PDG->at(j)==-13) && PDGMother->at(j)==0) //consider only primary muons
           {
               ...
               float xSt = MCPStartX->at(j);
               float ySt = MCPStartY->at(j);
               float zSt = MCPStartZ->at(j);
               ...
               if(!nocut){
                    if(!(xSt<LArFiducial[1]&&xSt>LArFiducial[0]&&
                         ySt<LArFiducial[3]&&ySt>LArFiducial[2]&&
                         zSt<LArFiducial[5]&&zSt>LArFiducial[4])) {continue;} //LAr fiducial volume
               } 
    ...
    FitSlicesYCustom(pVSfrac_resid_SL,double_gauss,pSlices,"p",nocut);
    FitSlicesYCustom(nhitsVSfrac_resid_SL,double_gauss,nhitsSlices,"nhits",nocut);
    FitSlicesYCustom(ThetaVSfrac_resid_SL,double_gauss,ThetaSlices,"Theta",nocut);
    ...
    #pragma region "Plotting"
        ...
        hnhits_RecoTracks_Sample->SetMaximum(5000000);
        hnhits_RecoTracks_Sample->Draw();
        if (nocut) mccanvasnhits->Print("Spill/nhits1D_spill.png");
        else mccanvasnhits->Print("Spill_Fiducial/nhits1D.png");
        ...
        hptrueStart_InGAr_Sample->SetMaximum(105000);
        hptrueStart_InGAr_Sample->Draw();
        if (nocut) mccanvasp->Print("Spill/ptrue1D_spill.png");
        else mccanvasp->Print("Spill_Fiducial/ptrue1D.png");
        ...
        htheta_InGAr_Sample->SetMaximum(12000);
        if (nocut) mccanvasTheta->Print("Spill/Thetatrue1D_spill.png");
        else mccanvasTheta->Print("Spill_Fiducial/Thetatrue1D.png");
        ...
        if (nocut) mccanvaspVSnhits->Print("Spill/nhitsVSp_spill.png");
        else mccanvaspVSnhits->Print("Spill_Fiducial/nhitsVSp.png");
        ...
        if (nocut) mccanvasPpVSnhits->Print("Spill/PnhitsVSp_spill.png");
        else mccanvasPpVSnhits->Print("Spill_Fiducial/PnhitsVSp.png");
        ...
        if (nocut) mccanvasThetaVSnhits->Print("Spill/nhitsVSTheta_spill.png");
        else mccanvasThetaVSnhits->Print("Spill_Fiducial/nhitsVSTheta.png");
        ...
        if (nocut) mccanvasPThetaVSnhits->Print("Spill/PnhitsVSTheta_spill.png");
        else mccanvasPThetaVSnhits->Print("Spill_Fiducial/PnhitsVSTheta.png");
        ...
        pVSnhits_projY->Draw();
        if (nocut) mccanvas_pVSnhitsProj->Print("Spill/pVSpVSnhits_projY_spill.png");
        else  mccanvas_pVSnhitsProj->Print("Spill_Fiducial/pVSnhits_projY.png");
        ...
        //hnhits_RecoTracks_Matched->SetMaximum();
        if (nocut) mccanvasnhitsm->Print("Spill/nhits1D_matched_spill.png");
        else mccanvasnhitsm->Print("Spill_Fiducial/nhits1D_matched.png");
        ...
        hptrueStart_InGAr_Matched->SetMaximum(2000);
        if(nocut) mccanvaspm->Print("Spill/ptrue1D_matched_spill.png");
        else mccanvaspm->Print("Spill_Fiducial/ptrue1D_matched.png");
        ...
        htheta_InGAr_Matched->SetMaximum(4000);
        if(nocut) mccanvasThetam->Print("Spill/Thetatrue1D_matched_spill.png");
        else mccanvasThetam->Print("Spill_Fiducial/Thetatrue1D_matched.png");
        ...
        hnhits_RecoTracks_Matched->SetMaximum(0.75);
        hnhits_RecoTracks_Matched->Draw();
        if (nocut) mccanvasHitsEff->Print("Spill/nhits1D_Efficiency_spill.png");
        else mccanvasHitsEff->Print("Spill_Fiducial/nhits1D_Efficiency.png");
        ...
        hptrueStart_InGAr_Matched->Draw();
        if(nocut) mccanvasPEff->Print("Spill/ptrue1D_Efficiency_spill.png");
        else mccanvasPEff->Print("Spill_Fiducial/ptrue1D_Efficiency.png");
        ...
        htheta_InGAr_Matched->SetMaximum(0.4);
        htheta_InGAr_Matched->Draw();
        if(nocut) mccanvasAngleEff->Print("Spill/Thetatrue1D_Efficiency_spill.png");
        else mccanvasAngleEff->Print("Spill_Fiducial/Thetatrue1D_Efficiency.png");

        ///////////////////////////////////////////////1D normalized distributions for three main variables
        TCanvas *mccanvasnhitsn = new TCanvas("mccanvasnhitsn","",1000,800);
        hnhits_RecoTracks_Sample->SetTitle("number of hits normalized distribution for all muon tracks in GAr;n_{hits};n");
        hnhits_RecoTracks_Sample->Scale(hnhits_RecoTracks_Sample->GetXaxis()->GetBinWidth(1)/(hnhits_RecoTracks_Sample->Integral()));
        hnhits_RecoTracks_Sample->SetMaximum(0.25);
        hnhits_RecoTracks_Sample->Draw();
        if (nocut) mccanvasnhitsn->Print("Spill/nhits1D_norm_spill.png");
        else mccanvasnhitsn->Print("Spill_Fiducial/nhits1D_norm.png");

        TCanvas *mccanvaspn = new TCanvas("mccanvaspn","",1000,800);
        hptrueStart_InGAr_Sample->SetTitle("p_{true} normalized distribution for the sample of muons traversing GAr;p_{true}^{St}(GeV/c);n");
        hptrueStart_InGAr_Sample->Scale(hptrueStart_InGAr_Sample->GetXaxis()->GetBinWidth(1)/(hptrueStart_InGAr_Sample->Integral()));
        hptrueStart_InGAr_Sample->SetMaximum(0.015);
        hptrueStart_InGAr_Sample->Draw();
        if (nocut) mccanvaspn->Print("Spill/ptrue1D_norm_spill.png");
        else mccanvaspn->Print("Spill_Fiducial/ptrue1D_norm.png");

        TCanvas *mccanvasThetan = new TCanvas("mccanvasThetan","",1000,800);
        htheta_InGAr_Sample->SetTitle("#theta_{true} distribution for the sample of muons traversing GAr;#theta_{true}^{St}(deg);n");
        htheta_InGAr_Sample->Scale(htheta_InGAr_Sample->GetXaxis()->GetBinWidth(1)/(htheta_InGAr_Sample->Integral()));
        htheta_InGAr_Sample->SetMaximum(0.8);
        htheta_InGAr_Sample->Draw();
        if (nocut) mccanvasThetan->Print("Spill/Thetatrue1D_norm_spill.png");
        else mccanvasThetan->Print("Spill_Fiducial/Thetatrue1D_norm.png");
        ...
        if (nocut) mccanvascharge->Print("Spill/ChargeRes_ErrorBars_p_spill.png");
        else mccanvascharge->Print("Spill_Fiducial/ChargeRes_ErrorBars_p.png");
        ...
        if (nocut) mccanvaschargenhits->Print("Spill/ChargeRes_ErrorBars_nhits_spill.png");
        else mccanvaschargenhits->Print("Spill_Fiducial/ChargeRes_ErrorBars.png");
        ...
        if (nocut) mccanvaschargeTheta->Print("Spill/ChargeRes_ErrorBars_Theta_spill.png");
        else mccanvaschargeTheta->Print("Spill_Fiducial/ChargeRes_ErrorBars_Theta.png");
        ...
        gauss2->SetLineStyle(9);
        gauss2->Draw("SAME");
        if (nocut) mccanvas_fracresid->Print("Spill/Frac_resid_two_gauss_fullspectrum_spill.png");
        else mccanvas_fracresid->Print("Spill_Fiducial/Frac_resid_two_gauss_fullspectrum.png");
        ...
        if (nocut) mccanvas_pVSfracresid->Print("Spill/pVSFrac_resid_spill.png");
        else  mccanvas_pVSfracresid->Print("Spill_Fiducial/pVSFrac_resid.png");
        ...
        if (nocut) mccanvas_pVSfracresidP->Print("Spill/PpVSFrac_resid_spill.png");
        else  mccanvas_pVSfracresidP->Print("Spill_Fiducial/PpVSFrac_resid.png");
        ...
        if (nocut) mccanvas_pVSfracresidProj->Print("Spill/pVSFrac_resid_proj_spill.png");
        else  mccanvas_pVSfracresidProj->Print("Spill_Fiducial/pVSFrac_resid_proj.png");
        ...
        if (nocut) mccanvas_hitsVSfracresid->Print("Spill/nhitsVSFrac_resid_spill.png");
        else  mccanvas_hitsVSfracresid->Print("Spill_Fiducial/nhitsVSFrac_resid.png");
        ...
        if (nocut) mccanvas_hitsVSfracresidP->Print("Spill/PnhitsVSFrac_resid_spill.png");
        else  mccanvas_hitsVSfracresidP->Print("Spill_Fiducial/PnhitsVSFrac_resid.png");
        ...
        if (nocut) mccanvas_ThetaVSfracresid->Print("Spill/ThetaVSFrac_resid_spill.png");
        else  mccanvas_ThetaVSfracresid->Print("Spill_Fiducial/ThetaVSFrac_resid.png");
        ...
        if (nocut) mccanvas_ThetaVSfracresidP->Print("Spill/PThetaVSFrac_resid_spill.png");
        else  mccanvas_ThetaVSfracresidP->Print("Spill_Fiducial/PThetaVSFrac_resid.png");
        ...
        hpSlices0->SetMaximum(110000);
        hpSlices0->Draw();
        if (nocut) mccanvas_param0p->Print("Spill/pslices_0_spill.png");
        else  mccanvas_param0p->Print("Spill_Fiducial/pslices_0.png");
        ...
        hpSlices1->Draw();
        if (nocut) mccanvas_param1p->Print("Spill/pslices_1_spill.png");
        else  mccanvas_param1p->Print("Spill_Fiducial/pslices_1.png");
        ...
        hpSlices2->Draw();
        if (nocut) mccanvas_param2p->Print("Spill/pslices_2_spill.png");
        else  mccanvas_param2p->Print("Spill_Fiducial/pslices_2.png");

        TCanvas *mccanvas_param3p = new TCanvas("mccanvas_param3p","",1000,800);
        TH1D* hpSlices3=(TH1D*) pSlices.At(3);
        hpSlices3->SetMinimum(0.0);
        hpSlices3->SetMaximum(0.4);
        hpSlices3->Draw();
        if (nocut) mccanvas_param3p->Print("Spill/pslices_3_spill.png");
        else  mccanvas_param3p->Print("Spill_Fiducial/pslices_3.png");

        TCanvas *mccanvas_param4p = new TCanvas("mccanvas_param4p","",1000,800);
        TH1D* hpSlices4=(TH1D*) pSlices.At(4);
        hpSlices4->SetMinimum(-0.02);
        hpSlices4->SetMaximum(0.02);
        hpSlices4->Draw();
        if (nocut) mccanvas_param4p->Print("Spill/pslices_4_spill.png");
        else  mccanvas_param4p->Print("Spill_Fiducial/pslices_4.png");

        TCanvas *mccanvas_param5p = new TCanvas("mccanvas_param5p","",1000,800);
        TH1D* hpSlices5=(TH1D*) pSlices.At(5);
        hpSlices5->SetMinimum(0.0);
        hpSlices5->SetMaximum(0.2);
        hpSlices5->Draw();
        if (nocut) mccanvas_param5p->Print("Spill/pslices_5_spill.png");
        else  mccanvas_param5p->Print("Spill_Fiducial/pslices_5.png");

        TCanvas *mccanvas_paramchip = new TCanvas("mccanvas_paramchip","",1000,800);
        TH1D* hpSlices6=(TH1D*) pSlices.At(6);
        hpSlices6->SetMinimum(0);
        hpSlices6->SetMaximum(16);
        hpSlices6->Draw();
        if (nocut) mccanvas_paramchip->Print("Spill/pslices_chi_spill.png");
        else  mccanvas_paramchip->Print("Spill_Fiducial/pslices_chi.png");
        ...
        hnhitsSlices0->SetMaximum(90000);
        hnhitsSlices0->Draw();
        if (nocut) mccanvas_param0nhits->Print("Spill/nhitsslices_0_spill.png");
        else  mccanvas_param0nhits->Print("Spill_Fiducial/nhitsslices_0.png");
        ...
        hnhitsSlices1->SetMaximum(-0.004);
        hnhitsSlices1->Draw();
        if (nocut) mccanvas_param1nhits->Print("Spill/nhitsslices_1_spill.png");
        else  mccanvas_param1nhits->Print("Spill_Fiducial/nhitsslices_1.png");
        ...
        hnhitsSlices2->SetMinimum(0.0);
        hnhitsSlices2->SetMaximum(0.05);
        hnhitsSlices2->Draw();
        if (nocut) mccanvas_param2nhits->Print("Spill/nhitsslices_2_spill.png");
        else  mccanvas_param2nhits->Print("Spill_Fiducial/nhitsslices_2.png");
        ...
        hnhitsSlices3->Draw();
        if (nocut) mccanvas_param3nhits->Print("Spill/nhitsslices_3_spill.png");
        else  mccanvas_param3nhits->Print("Spill_Fiducial/nhitsslices_3.png");

        TCanvas *mccanvas_param4nhits = new TCanvas("mccanvas_param4nhits","",1000,800);
        TH1D* hnhitsSlices4=(TH1D*) nhitsSlices.At(4);
        hnhitsSlices4->SetMinimum(-0.12);
        hnhitsSlices4->SetMaximum(0.02);
        hnhitsSlices4->Draw();
        if (nocut) mccanvas_param4nhits->Print("Spill/nhitsslices_4_spill.png");
        else  mccanvas_param4nhits->Print("Spill_Fiducial/nhitsslices_4.png");

        TCanvas *mccanvas_param5nhits = new TCanvas("mccanvas_param5nhits","",1000,800);
        TH1D* hnhitsSlices5=(TH1D*) nhitsSlices.At(5);
        hnhitsSlices5->SetMinimum(0);
        hnhitsSlices5->SetMaximum(0.3);
        //hnhitsSlices5->Fit("InverseSqrt","Q","",6,11);
        hnhitsSlices5->Draw();
        if (nocut) mccanvas_param5nhits->Print("Spill/nhitsslices_5_spill.png");
        else  mccanvas_param5nhits->Print("Spill_Fiducial/nhitsslices_5.png");
        ...
        hnhitsSlices6->SetMaximum(20);
        hnhitsSlices6->Draw();
        if (nocut) mccanvas_paramchinhits->Print("Spill/nhitsslices_chi_spill.png");
        else  mccanvas_paramchinhits->Print("Spill_Fiducial/nhitsslices_chi.png");
        ...
        hThetaSlices0->SetMaximum(12000);
        hThetaSlices0->Draw();
        if (nocut) mccanvas_param0Theta->Print("Spill/Thetaslices_0_spill.png");
        else  mccanvas_param0Theta->Print("Spill_Fiducial/Thetaslices_0.png");

        TCanvas *mccanvas_param1Theta = new TCanvas("mccanvas_param1Theta","",1000,800);
        TH1D* hThetaSlices1=(TH1D*) ThetaSlices.At(1);
        hThetaSlices1->SetMinimum(-0.025);
        hThetaSlices1->SetMaximum(-0.005);
        hThetaSlices1->Draw();
        if (nocut) mccanvas_param1Theta->Print("Spill/Thetaslices_1_spill.png");
        else  mccanvas_param1Theta->Print("Spill_Fiducial/Thetaslices_1.png");
        ...
        hThetaSlices2->SetMaximum(0.07);
        hThetaSlices2->Draw();
        if (nocut) mccanvas_param2Theta->Print("Spill/Thetaslices_2_spill.png");
        else  mccanvas_param2Theta->Print("Spill_Fiducial/Thetaslices_2.png");
        ...
        hThetaSlices3->Draw();
        if (nocut) mccanvas_param3Theta->Print("Spill/Thetaslices_3_spill.png");
        else  mccanvas_param3Theta->Print("Spill_Fiducial/Thetaslices_3.png");
        ...
        hThetaSlices4->Draw();
        if (nocut) mccanvas_param4Theta->Print("Spill/Thetaslices_4_spill.png");
        else  mccanvas_param4Theta->Print("Spill_Fiducial/Thetaslices_4.png");
        ...
        hThetaSlices5->Draw();
        if (nocut) mccanvas_param5Theta->Print("Spill/Thetaslices_5_spill.png");
        else  mccanvas_param5Theta->Print("Spill_Fiducial/Thetaslices_5.png");
        ...
        hThetaSlices6->SetMaximum(6);
        hThetaSlices6->Draw();
        if (nocut) mccanvas_paramchiTheta->Print("Spill/Thetaslices_chi_spill.png");
        else  mccanvas_paramchiTheta->Print("Spill_Fiducial/Thetaslices_chi.png");
