...
void garana::l2g_Trackmatch()
{
    ...
    #pragma region "Plotting"
        ...
        hnhits_RecoTracks_Sample->Draw();
        if (edge) mccanvasnhitsn->Print("Edge/nhits1D_norm_edge.png");
        else mccanvasnhitsn->Print("Standard/nhits1D_norm.png");
        ...
        hptrueStart_InGAr_Sample->Draw();
        if (edge) mccanvaspn->Print("Edge/ptrue1D_norm_edge.png");
        else mccanvaspn->Print("Standard/ptrue1D_norm.png");

        TCanvas *mccanvasThetan = new TCanvas("mccanvasTheta","",1000,800);
        htheta_InGAr_Sample->SetTitle("#theta_{true} distribution for the sample of muons traversing GAr;#theta_{true}^{St}(deg);n");
        ...
        htheta_InGAr_Sample->Draw();
        if (edge) mccanvasThetan->Print("Edge/Thetatrue1D_norm_edge.png");
        else mccanvasThetan->Print("Standard/Thetatrue1D_norm.png");
