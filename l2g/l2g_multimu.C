...
void l2g_multimu()
{
    ...
    TH2F* N2_DTSpread = new TH2F("N2_DTSpread", "DTSpread at LAr Exit", 100, 0, 20, 100, 0, 800);
    TH2F* N3_DTSpread = new TH2F("N3_DTSpread", "DTSpread at LAr Exit", 100, 0, 20, 100, 0, 800);
    TH2F* N4_DTSpread = new TH2F("N4_DTSpread", "DTSpread at LAr Exit", 100, 0, 20, 100, 0, 800);

    TH2F* PN2_DTSpread = new TH2F("PN2_DTSpread", "DTSpread at LAr Exit", 100, 0, 20, 100, 0, 800);
    TH2F* PN3_DTSpread = new TH2F("PN3_DTSpread", "DTSpread at LAr Exit", 100, 0, 20, 100, 0, 800);
    TH2F* PN4_DTSpread = new TH2F("PN4_DTSpread", "DTSpread at LAr Exit", 100, 0, 20, 100, 0, 800);
    ...
    for (Int_t i=0; i<nentries; i++) 
    {
        ...
        for (Int_t j=0; j<dx.size(); j++)
        {
            ...
            if(dt.at(j)<5 && sqrt(dx.at(j)*dx.at(j)+dy.at(j)*dy.at(j))<100) close++;
    ...
    mccanvasThetap_inLAr_nmu_q25->Print("h_p_theta_nmu_InLAr_mu_q25.png");
    ...
    mccanvasThetap_inLAr_nmu_q50->Print("h_p_theta_nmu_InLAr_mu_q50.png");
    ...
    mccanvasThetap_inLAr_nmu_q75->Print("h_p_theta_nmu_InLAr_mu_q75.png");
    ...
    mccanvas_DT_N2->Print("N2_DTSpread.png");
    ...
    mccanvas_DT_N3->Print("N3_DTSpread.png");
    ...
    mccanvas_DT_N4->Print("N4_DTSpread.png");
    ...
    mccanvas_DT_N2P->Print("PN2_DTSpread.png");
    ...
    mccanvas_DT_N3P->Print("PN3_DTSpread.png");
    ...
    mccanvas_DT_N4P->Print("PN4_DTSpread.png");
    ...
    mccanvas_nmuons->Print("Muons_per_event_atleast1.png");
    ...
    mccanvas_nmuons_InLAr->Print("Muons_per_event_InLAr_atleast1.png");
    ...
    mccanvas_pnp->Print("PNP_atleast1.png");
    ...
    mccanvas_pnp_InLAr->Print("PNP_InLAr_atleast1.png");
