...
void KalmanFit(  
                                ...
                                )
    {
      ...
      const int nplanes = 5;
      double Planes_Z[]={1244,1248,1334,1338,1484,1488,1634,1638,1724,1728};;
      if (dir<0) 
      {
...
void kalman_helix_garlite_Alice_Eloss_test_corr_pred_rndm_test(size_t nevents)

    {
      ...
      TFile fs("./toygarlite/nosmear_realseed_elosscorr_fixedp0.7/garlitetest_nosmear_realseed_elosscorr_r001_001_fixedp0.7.root","recreate");
      ...
      const int  nplanes = 5 ;
      double  Planes_X[] =   {-300,300,-300,300,-300,300,-300,300,-300,300};
      double  Planes_Y[] =   {-400,100,-400,100,-400,100,-400,100,-400,100};
      double  Planes_Z[] =   {1244,1248,1334,1338,1484,1488,1634,1638,1724,1728};
