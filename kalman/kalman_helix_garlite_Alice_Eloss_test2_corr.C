                ...
                if((zh>Planes_Z[p*2] && zh<Planes_Z[p*2+1]))
                  {
                    ...
                    if(abs(deltaxyz)>20)
                    {
                      ...
                      Double_t f1in=parvecprev[2];
                      Double_t f2in=f1in + z2rin;      
                      Double_t r1in=TMath::Sqrt((1.-f1in)*(1.+f1in)), r2in=TMath::Sqrt((1.-f2in)*(1.+f2in));                
                      if (TMath::Abs(f1in) >= kAlmost1 || TMath::Abs(f2in) >= kAlmost1 || TMath::Abs(parvecprev[3])< kAlmost0 || TMath::Abs(r1)<kAlmost0 || TMath::Abs(r2)<kAlmost0) 
                      {
                        std::cout<<"f1in: "<<f1in<<" f2in: "<<f2in<<" r1: "<<r1<<" r2: "<<r2<<" tantambdaprev: "<<parvecprev[3]<<std::endl;
                        status= false;
                        break;
                      }
                      ...
                      if (TMath::Abs(f1in) >= kAlmost1 || TMath::Abs(f2in) >= kAlmost1 || TMath::Abs(parvec[3])< kAlmost0 || TMath::Abs(r1)<kAlmost0 || TMath::Abs(r2)<kAlmost0) 
                      {
                        std::cout<<"f1in: "<<f1in<<" f2in: "<<f2in<<" r1: "<<r1<<" r2: "<<r2<<" tantambda: "<<parvec[3]<<std::endl;
                        status= false;
                        break;
                      }
...
void kalman_helix_garlite_Alice_Eloss_test_corr(size_t nevents)

    {
      ...
      TFile fs("garlitetest_nosmear_realseed_allhits_elosscorr_r5_5.root","recreate");
