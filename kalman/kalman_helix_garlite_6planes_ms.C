...
void kalman_helix_garlite_6planes_ms(size_t nevents)

    {
      ...
      TFile fs("./toygarlite/6planes/smearx05y05_aliceseed_elossgaussnocorr_fixedp0.7/garlitetest_smearx05y05_aliceseed_elossgaussnocorr_r05_05_fixedp0.7.root","recreate");
      ...
      Bool_t Multiple_Scat_corr = false;
      Bool_t Multiple_Scat = false;
      Bool_t Smear = true;
