...
void garana::Loop()
{
  ...
  //TH1F *fracresid  = new TH1F("fracresid","1<P<3 GeV, Thin ECAL;(reco P - true P)/(true P);muons",100,-1,1);
  TH1F *fracresid  = new TH1F("fracresid","3<P<5 GeV, Thin ECAL;(reco P - true P)/(true P);muons",100,-1,1);
  ...
  gStyle->SetOptFit(1);
  fracresid->Draw("e0");
  mccanvas1->Print("fracresid2.png");
